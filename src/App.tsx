...
const panels: ScenePanel[] = [
  {
    ...
    subtitle:
      "A living hub where every game glows, shifts, and responds to you.",
    tag: "Neon gate",
  },
  {
    id: "orbit",
    ...
    subtitle:
      "Pin, launch, and glide through worlds in a holographic control room.",
    tag: "Orbital UI",
  },
  {
    id: "flow",
...
function App() {
  ...
  useEffect(() => {
    ...
    scene.fog = new THREE.Fog("#010409", 6, 22);
    ...
    const mainMaterial = new THREE.MeshPhysicalMaterial({
      color: new THREE.Color("#0b1d17"),
      emissive: new THREE.Color("#0c6f4a"),
      roughness: 0.35,
      metalness: 0.7,
      transparent: true,
      opacity: 0.65,
    ...
    const accentMaterial = new THREE.MeshStandardMaterial({
      color: new THREE.Color("#17f4b0"),
      emissive: new THREE.Color("#17f4b0"),
    ...
    const snakeCurvePoints: THREE.Vector3[] = [];
    const snakeTurns = 80;
    for (let i = 0; i <= snakeTurns; i += 1) {
      const t = (i / snakeTurns) * Math.PI * 2;
      const radius = 3.2;
      const wobble = Math.sin(t * 4) * 0.24;
      snakeCurvePoints.push(
        new THREE.Vector3(Math.cos(t) * radius, wobble, Math.sin(t) * radius)
      );
    }
    const snakeCurve = new THREE.CatmullRomCurve3(snakeCurvePoints, true);
    const snakeGeometry = new THREE.TubeGeometry(
      snakeCurve,
      200,
      0.08,
      16,
    ...
    const snake = new THREE.Mesh(snakeGeometry, accentMaterial);
    scene.add(snake);
    ...
    const light = new THREE.PointLight("#18f4b2", 10, 25);
    light.position.set(2, 3, 4);
    scene.add(light);
    scene.add(new THREE.AmbientLight("#061410", 1.8));
      ...
      <main>
        <section className="hero" id="hero" ref={heroRef}>
          ...
          <div className="hero__content">
            ...
            <p className="hero__subtitle">
              Futuristic hub for every world you own. Built like a cinematic
              control room.
            </p>
            <div className="hero__actions">
              <button className="btn btn--primary">
                Download fuer Windows
              </button>
        ...
        <section className="showcase" id="download">
          <div className="showcase__left" ref={setPanelRef}>
            ...
            <p>
              Soft parallax, layered blur, and light that follows your pointer.
            </p>
